...
citizens_editor_settings_gui:
    ...
    slots:
        ...
        - [edge-fill] [center-fill] [center-fill] [center-fill] [permissions-page] [center-fill] [center-fill] [center-fill] [edge-fill]
...
citizens_editor_permissions_page:
    ...
    debug: true
    inventory: CHEST
    title: <server.flag[citizens_editor.settings.interface.settings.gui-titles.permissions-page].parsed>
    gui: true
    definitions:
...
# | ------------------------------------------------------------------------------------------------------------------------------ | #
        ...
        after player left clicks item_flagged:npce-gui-button in citizens_editor_permissions_page|permissions-page:
            - ratelimit <player> 1t
            # |------- event data -------| #
            - define prefix <server.flag[citizens_editor.settings.prefixes.main]>
            - define button-id <context.item.flag[npce-gui-button].if_null[null]>
